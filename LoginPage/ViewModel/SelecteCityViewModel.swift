...
class SelecteCityViewModel {
    ...
    func cityData() {
        ...
        request.addValue("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjdXN0b21lcl9pZCI6MzU5MTUsImlhdCI6MTczNDY4MTAyMiwiZXhwIjoxNzM1MTEzMDIyfQ._u80z09DzkoRM-rvhzDzgQvP8GfDs_4RUWr5clzqa9E", forHTTPHeaderField: "Authorization")
